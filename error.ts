...
/**
 * This class provides a wrapper for network errors when making requests to Timmi Absences API
 */
export class LuccaTimmiAbsencesError extends Error {
  /**
   * The response body
   */
  ...
  constructor(axiosError: AxiosError, responseBody: unknown) {
    ...
    this.name = "LuccaTimmiAbsencesError";
